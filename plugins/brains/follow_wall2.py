...
class Avoid(Brain):
    ...
    def follow_wall(self, front, left_front, right_front):
        ...
        if self.wall == 1:
            ...
            if left_front > 0.7:
                return(0.6, 0.2)
            elif (left_front <= 0.7) and (left_front > 0.6):
                return(0.6, 0.1)
            elif (left_front <= 0.6) and (left_front > 0.5):
                return(0.7, 0.1)
            elif (left_front == 0.5):
                return(0.9, 0.0)
            elif (left_front < 0.5) and (left_front > 0.4):
                return(0.7, -0.1)
            elif (left_front <= 0.4) and (left_front > 0.3):
                return(0.5, -0.1)
            elif left_front <= 0.3:
                return(0.4, -0.4)
            ...
            if right_front > 0.7:
                return(0.2, -0.5)
            elif (right_front <= 0.7) and (right_front > 0.6):
                return(0.4, -0.2)
            elif (right_front <= 0.6) and (right_front > 0.55):
                return(0.5, -0.1)
            elif (right_front <= 0.55) and (right_front > 0.45):
                return(0.6, 0.0)
            elif (right_front <= 0.45) and (right_front > 0.4):
                return(0.5, 0.1)
            elif (right_front <= 0.4) and (right_front > 0.3):
                return(0.4, 0.2)
            elif right_front <= 0.3:
                return(0.2, 0.5)
...
def INIT(engine):
    ...
    return Avoid("follow_wall2", engine)
