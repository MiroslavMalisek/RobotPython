...
from pyrobot.simulators.pysim import TkPioneer, PioneerFrontSonars


def INIT():
    # (width, height), (offset x, offset y), scale
    sim = LineSimulation((450, 675), (20, 650), 32, background="lineBackground.png")
    ...
    sim.addRobot(
        ...
        TkPioneer(
            ...
            # 8.5, 2.35, 1.57,
            ((0.185, 0.185, -0.185, -0.185), (0.2, -0.2, -0.2, 0.2)),
        ),
    )
